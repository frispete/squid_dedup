...
def getproxies_environment():
    ...
    If both lowercase and uppercase variables exist, the lowercase
    variant is prioritized.
    """
    proxies = {}
    # in order to prioritize lowercase variables, 
    # process environment in two passes
